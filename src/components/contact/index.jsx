...
import contactBanner from "../../assets/img/contactusBanner.png";
              ...
              <div data-aos-duration="700" data-aos="fade-up">
                <div className="contact-detail-wrap">
                  ...
                  <div className="invst-wrap">
                    ...
                    <a href="mailto:jay@geothermal.io" className="contact-link">
                      jay@geothermal.io
                    </a>
                  </div>

                  <div className="invst-wrap">
                    <p className="invstr-name">Sushim Shah</p>
                    <p className="invstr-position">CFO</p>
                    <a
                      href="mailto:mshoemaker@geothermal.io"
                      className="contact-link"
                    >
                      sushim@geothermal.io
                    </a>
                  </div>
                  ...
                  <div className="invst-wrap">
                    ...
                    <a
                      href="mailto:adavidoff@geothermal.io"
                      className="contact-link"
                    >
                      adavidoff@geothermal.io
                    </a>
                  </div>
                </div>
              </div>
              ...
              <div className="media-inq-wrap">
                <div className="media-inq">
                  ...
                  <div className="inq-info-wrap">
                    ...
                    <div className="inq-info">
                      <p>Email</p>
                      <a href="mailto:squimby@geothermal.io">
                        squimby@geothermal.io
                      </a>
                    </div>
                  </div>
                </div>
                ...
                <Row className="g-4">
                  ...
                  <Col md="12">
                    ...
                    <div className="form-check">
                      ...
                      />
                      <label className="form-check-label">
                        I accept to receive communication from Geothermal
                      </label>
                    </div>
                  </Col>
      ...
      <Row className="justify-content-between contact">
        ...
        <Col md="4">
          <div className="card">
            ...
            <br />
            <p>Mayur Patel</p>
            <p className="address">Head of Operations</p>
            <div className="flex mt-20">
