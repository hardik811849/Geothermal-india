        ...
        <div className="row">
          <div className="col-xl-6 col-sm-12 col-12">
            <div className="detailsOne_">
              <p>
                GT Himalia utilizes modern state-of-the-art compact geothermal
                binary-cycle power plants using organic rankine cycle (orc)
                technology that optimizes relatively low-temperature geothermal
                resources for maximum power production and (up to 98%) uptime
                efficiency.
              </p>
            </div>
