...
const AboutUs = (props) => {
  ...
  const handleFilterFounder = (val) => {
    setActive(val);
    const filterTeam = Team.filter((res) => {
            ...
            <div className="row position-relative">
              ...
              >
                <div className="banner_text">
                  <h3>Our Mission</h3>
                  <p>
                    Our mission at GT Himalia is the successful deployment of
                    modularized ORC geothermal power plants within Texas, the
        ...
        <div className="bottom_text_section">
          <div className="">
            <div className="row">
              ...
              >
                <h3>
                  GT Himalia strives to produce an emissions free renewable
            ...
            <div className="about-us-mission">
              <div className="row">
                <div className="col-lg-6 col-sm-12 col-12 ">
                  ...
                  >
                    <h3>
                      GT Himalia mission is the deployment of the first
                    ...
                    <p>
                      ...
                      inexpensive. Geothermal will successfully develop and
                      responsibly produce geothermal energy and electricity.
                    </p>
                    <div className="bottom_section_p">
                      <p>
                        At GT Himalia, we're not just producing energy - we're
                  ...
                  {teamFilter.map((el) => (
                    ...
                    >
                      <div
                        ...
                        className="team_img"
                      >
                        <img src={el.img_path} className="img-fluid" />
