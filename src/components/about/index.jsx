...
const About = () => {
  ...
  return (
    <>
      ...
      <PageHeading heading="GEOTHERMAL'S MISSION IS THE DEPLOYMENT OF THE FIRST GEOTHERMAL POWER PLANT IN TEXAS​" />
          ...
          <div className="mission-content">
            ...
            >
              <p className="mission">
                ...
                that’s abundant and inexpensive. Geothermal will successfully
                develop and responsibly produce geothermal energy and
                electricity.
              </p>

              <p className="mission mt-3">
                Our mission at Geothermal Holis the successful deployment of
                modularized ORC geothermal power plants within Texas, the United
                States, and around the globe where geothermal resources are
                proven by mature oil & gas provinces and subsequent data. We
                strive to produce an emissions free renewable and alternative
                energy source that provides low-cost baseload electricity, 24/7
                and 365 days a year.
              </p>
            </div>
          </div>
          ...
          <div className="about-info-wrap">
            ...
            <div className="about-info-content">
              ...
              <p className="desc-text">
                GT Himalia is very conscious of carbon emissions, climate, and
                cultural values and continues to address and execute effective
                environmental, social, and governance (ESG) criteria using
                modern technology to mitigate and decelerate said environmental
                effects, while minimizing its carbon and environmental
                footprint, and any surface degradation, unlike solar and wind.​
              </p>
            </div>
          </div>
        </div>
