                  ...
                  <Row className="justify-content-between">
                    <Col lg="8">
                      <div className="highlight-text d-flex">
                        ...
                        <p> &nbsp;Geothermal media</p>
                      </div>

                      <PageHeading
                        heading="GT Himalia and GEG Power Partnering to Develop First Geothermal Power Plant in Texas"
                        align="text-start"
                      />
                      <div className="small-info-text">
                        HOUSTON, March 2, 2023 /PRNewswire/ -- Geothermal IO., a
                        geothermal exploration and production power company, and
                        GEG, ehf, a geothermal developer and EPC company, have
                        entered into a definitive agreement to form a Joint
                        Venture ("JV"). The primary focus of the JV is the
                        development of clean baseload electricity in Texas
                        powered by geothermal energy. The partners are now
                        engaged with origination of the first utility-scale,
                        geothermal power plant in the Lone Star State.
                      </div>
                      <div className="read-more">
                        <a
                          target="_blank"
                          href="https://www.prnewswire.com/news-releases/geothermal-core-and-geg-power-partnering-to-develop-first-geothermal-power-plant-in-texas-301761148.html"
                          className="text-btn"
                        >
                          Read More{" "}
                        </a>
