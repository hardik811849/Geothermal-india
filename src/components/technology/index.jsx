...
const Technology = () => {
  return (
    <>
      ...
      <PageHeading
        heading="GEOTHERMAL PROJECTS USES MODERN STATE-OF-THE-ART ORGANIC RANKINE CYCLE (ORC) POWER PLANTS THAT CAN OPERATE FOR DECADES"
        align="text-start"
      />
          ...
          <Col md="6" xl="4">
            ...
            >
              <TechnologyBox
                ...
                title="TECHNOLOGY"
                desc="Defines proprietary technology for Enhanced Geothermal Systems (or EGS) "
              />
            </div>
          </Col>
        </Row>
