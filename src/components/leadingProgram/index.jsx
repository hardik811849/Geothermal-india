      ...
      <div className="leader-content">
        ...
        <div data-aos-duration="700" data-aos="fade-up" data-aos-delay="200">
          <p className="leader-text">
            Developed in 2021, the Geothermal Leadership Program reflects our
            ...
            By exposing these rising stars to our full immersion strategy and
            teaching them about our solutions-driven approach, we are proud to
            build new leaders in our field and provide career pathways for young
            minds. Often, the pathway to employment is in the Geothermal
            portfolio, establishing both an exciting outcome for the team member
            and an extension of expert partnership to our portfolio.
          </p>
        </div>
      </div>
