...
import scicatBanner from "../../assets/img/scicatBanner.png";
...
const BinaryPlant = () => {
  return (
    <>
      <Loader />
      <InnerBanner title="TECHNOLOGY" image={scicatBanner} />
      <PageHeading
        heading="3-D SEISMIC TECHNOLOGY FOR ENHANCED GEOTHERMAL SYSTEMS AND MAXIMUM PRODUCTION"
        align="text-start"
      />
