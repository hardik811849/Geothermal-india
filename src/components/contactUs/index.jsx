...
const ContactUs = () => {
  ...
  //   emailjs.send('YOUR_SERVICE_ID', 'YOUR_TEMPLATE_ID', dataDetails, 'YOUR_USER_ID')
  //     .then((result) => {
    ...
    <>
      ...
      <div className="">
        ...
        <div className="contact-form ">
          <div className="row ">
            <div className="col-xl-5 col-sm-12 col-12 ml-2  address_info_heading">
              ...
              <div className="contact_Investors_details">
                ...
                <h5>Sushim Shah</h5>
                <p>CEO & CFO</p>
                <p>sushim@geothermal.io</p>
              </div>
            </div>

            {/* <div className="col-1"></div> */}
            <div className="col-xl-7 col-sm-12 col-12 p-0  mt-xl-0 mt-4">
