  ...
  return (
    <>
      <div className="terms">
        ...
        <h2 className="">Last revised on:February 9th, 2024 </h2>
        <p>
          The website located at https://www.geothermal.io (the “Site”) belongs
          to GT, a Delaware corporation, together with its affiliates
          ...
          additional terms, guidelines, and rules are formed by reference into
          these Terms.{" "}
        </p>
        ...
        <p>
          ...
          features of the Site, you must register for an account (“Account”) and
          ...
          will maintain the accuracy of such information and (c) that you are in
          compliance with the applicable law, legislation, regulations, and
          rules in your Country of residence or any other jurisdiction
          applicable to you. You may delete your Account at any time, for any
        ...
        <p>
          <strong> 1.2 Account Verification.</strong> If we have an account, to
          finish creating your account with us, you shall provide us with the
          information we request. We collect, verify and retain information for
          ...
          Such information may include your name, address, telephone number,
          email address, date of birth, banking information, and a picture of
          yourself holding your government-issued identification card. We may
          also request information regarding the source of your funds,
          income/employment information, and any additional information required
          for to comply with Applicable Laws and Regulations. When you provide
          information to us, you verify that the information provided is
          accurate and complete, and you agree to notify us in writing of any
          changes made to the information you provide. You hereby authorize us,
          directly or through a third party, to make any inquiries we consider
          necessary to verify your identity and/or protect against fraud,
          including but not limited to: (a) query identity information contained
          in public reports (e.g., your name, address, past addresses, or date
          of birth); and (b) take action we reasonably deem necessary based on
          ...
          directed to fully respond to such inquiries or requests. We will have
          no liability or responsibility for any permanent or temporary
        ...
        <p>
          ...
          for maintaining the confidentiality of your Account login information
          and are fully responsible for all activities that occur under your
          Account. If you permit others to use your account credentials, you are
          responsible for the activities of such users that occur in connection
          with your account. You will not (i) add or attempt to add any other
          person’s Account information to your account, (ii) use or attempt to
          use another user’s account without authorization from that user and us
          or (iii) impersonate or post on behalf of any person or entity or
          otherwise mispresent your affiliation with a person or entity. You
        ...
        <p>
          <strong> 2.1 License.</strong> Subject to these Terms, Company grants
        ...
        <p>
          <strong> 2.2 Certain Restrictions.</strong> The rights granted to you
          ...
          in part, or any content displayed on the Site; (b) you shall not
        ...
        <p>
          <strong> 2.3 Modification.</strong> Company reserves the right, at any
          time, to modify, suspend, or discontinue the Site (in whole or in
          part) with or without notice to you. You agree that Company will not
        ...
        <p>
          ...
          may provide (defined below), you acknowledge that all the intellectual
          ...
          expressly set forth in Section 3.1. Company and its suppliers reserve
        ...
        <p>
          ...
          information and content that a user submits to, or uses with, the Site
        ...
        <p>
          <strong> 3.2 License.</strong> You hereby grant (and you represent and
          ...
          Content in the Site. You hereby irrevocably waive (and agree to cause
        ...
        <p>
          ...
          patent, trade secret, moral right, privacy right, right of publicity,
          or any other intellectual property or proprietary right; (ii) that is
          unlawful, predatory, harassing, abusive, tortious, threatening,
        ...
        <p>
          ...
          access to the Site (or to other computer systems or networks connected
          to or used together with the Site), whether through password mining or
          ...
          mine data from) the Site (provided, however, that we conditionally
          ...
          such materials, subject to the parameters set forth in our robots.txt
          file).
        </p>
        <p>
        ...
        <p>
          ...
          ATTORNEYS, AND AGENTS) HARMLESS, INCLUDING COSTS AND ATTORNEYS’ FEES,
          ...
          CONTENT. YOU AGREE TO PROMPTLY NOTIFY COMPANY OF ANY THIRD-PARTY
          CLAIMS. COMPANY RESERVES THE RIGHT, AT YOUR EXPENSE, TO ASSUME THE
        ...
        <p>
          ...
          transaction in connection with such Third-Party Links & Ads. The
          Company is not responsible or liable, directly or indirectly, for any
          damage or loss caused or alleged to be caused by or in connection with
          use of or reliance on any content, information, events, goods or
          services available by or through such Third Party.
        </p>
        <p>
          ...
          other Site users are solely between you and such users. You agree that
        ...
        <p>
          ...
          discharge the Company (and our officers, employees, attorneys, agents,
          successors, and assigns) from, and hereby waive and relinquish, each
          and every past, present and future dispute, claim, controversy,
        ...
        <p>
          ...
          TAX OR FINANCIAL ADVICE. COMPANY IS NOT A FINANCIAL PLANNER, BROKER OR
          TAX ADVISOR. BEFORE USING THIS SITE, YOU SHOULD SEEK ADVICE FROM YOUR
        ...
        <p>
          ...
          TO YOU FOR ANY DAMAGES ARISING FROM OR RELATED TO THIS AGREEMENT (FOR
          ANY CAUSE WHATSOEVER AND REGARDLESS OF THE FORM OF THE ACTION), WILL
          AT ALL TIMES BE LIMITED TO THE GREATER OF FIFTY US DOLLARS (U.S. $50)
          OR THE AMOUNT YOU PAID TO USE OUR SERVICES. THE EXISTENCE OF MORE THAN
        ...
        <p>
          ...
          appropriate tax authority. Company is not obligated to, and will not,
          determine whether taxes apply, or calculate, collect, report or remit
          any taxes to any tax authority arising from your use of the Service.{" "}
        </p>
        <br />
        <h3>
        ...
        <p>
          <strong> 10.1 No Offer; No Solicitation.</strong> The information and
          any materials contained in the Site should not be considered as an
          offer or solicitation to buy or sell financial instruments, provide
          financial advice, create a trading platform, facilitate or take
          deposits or provide any other financial services of any kind in any
          jurisdiction.{" "}
        </p>
        <p>
          ...
          should obtain appropriate professional advice when necessary. It does
          not take into account your objectives, financial situation or needs.{" "}
        </p>
        <br />
        <h3>
          <strong>
        ...
        <p>
          ...
          (including those not discussed herein), all of which could render your
          digital assets worthless or of little value.{" "}
        </p>
        <p>
          <strong> 11.2 Your Sole Risk.</strong> Investing in digital assets is
          at your sole risk and any digital assets purchased are provided, used
          and acquired on an “AS IS” and on an “AS AVAILABLE” basis without
          representations, warranties, promises or guarantees whatsoever of any
          kind by Company. You must rely on your own examination and
          investigation thereof.{" "}
        </p>
        <p>
          <strong> 11.3 Purchase Price Risk.</strong> There are no guarantees as
          to the price of digital assets purchased by you and no guarantees that
          the price per digital assets determined by the market will be equal to
          or higher than your purchase price. There is the possibility that the
          price per digital assets may fall below the price paid by you.{" "}
        </p>
        <p>
          <strong> 11.4 Ability to Transact or Resell.</strong> You may be
          unable to sell or otherwise transact in digital assets at any time, or
          for the price you paid due to (a) diminution in value of the digital
          assets; (b) lack of liquidity for the digital assets; or (c)
          restrictions on the transferability of the digital assets.{" "}
        </p>
        <p>
          <strong> 11.5 Regulatory Framework.</strong> Our technology may be
          used worldwide. It is difficult to predict how or whether governmental
          authorities may regulate such technologies. It is likewise difficult
          to predict how or whether any governmental authority may make changes
          to existing laws, regulations or rules that may affect our technology
          and its applications. Such changes could negatively impact digital
          assets in various ways, including, for example, through a
          determination that digital assets are a regulated financial instrument
        ...
        <p>
          <strong> 12.1 </strong> You must be at least 18 years old. To use the
          services, you must create an account and take action when certain
          events take place, including having an email with safe password. You
          must provide accurate information. If your information has been given
          to a third party that is not approved to hold the information, you
          must inform us immediately. Do not inform others of your password. You
          are responsible for your username and password, account and user-name,
          or registration, if by you or others. We are given authority to act on
          data received through your use of our site, and are not responsible
          for any loss or damage. You agree to be part of our mailing list
          unless you are part of a state that requires certain approval prior to
        ...
        <p>
          ...
          or data available on our site, or that the use of or result of the use
          of the services, will be accurate, reliable, complete, current,
          ...
          videos or any other items on the site does not constitute a guarantee
          that any items represented when a buyer takes the property. You must
          conduct your own due diligence and investigate all matters relating to
          any companies. It is recommended that you seek legal, accounting,
          consulting or any other advice, for due diligence and that you use
          good faith efforts in determining whether the information is accurate.{" "}
        </p>
        <p>
        ...
        <p>
          <strong> 12.4 </strong> There may be third party content on our site.
          You acknowledge that we cannot assume responsibility for such content,
          services, or information. We do not guaranty or warrant accurate
        ...
        <p>
          ...
          decision to participate in any activity on this site. Use at your own
          risk.{" "}
        </p>
        <br />
        <h3>
        ...
        <p>
          ...
          earlier of thirty (30) calendar days following our dispatch of an
        ...
        <p>
          ...
          the use of any product or service provided by the Company that cannot
          be resolved informally shall be resolved by binding arbitration on an
        ...
        <p>
          ...
          the other party a written Notice of Dispute (“Notice”) describing the
          nature and basis of the claim or dispute, and the requested relief. A
          Notice to the Company should be sent to: 16107 Kensington Drive, #116,
          Sugar Land, Texas 77479. After the Notice is received, you and the
        ...
        <p>
          ...
          Arbitration Rules (“Arbitration Rules”) governing the arbitration are
          available online at www.adr.org or by calling AAA at 1-800-778-7879.
          The arbitration shall be conducted by a single, neutral arbitrator.
          Arbitration proceedings will be held in Houston, Texas. Any claims or
          ...
          to a hearing will be determined by the Arbitration Rules. Any judgment
          on the award rendered by the arbitrator may be entered in any court of
          competent jurisdiction. Each party shall bear its own costs (including
        ...
        <p>
          ...
          within the statute of limitations (i.e.,the legal deadline for filing
          a claim) and within any deadline imposed under the AAA Rules for the
          pertinent claim.{" "}
        </p>
        <p>
          ...
          any, of you and the Company, and the dispute will not be consolidated
        ...
        <p>
          <strong> (G). Waiver of Jury Trial.</strong> THE PARTIES HEREBY WAIVE
          THEIR CONSTITUTIONAL AND STATUTORY RIGHTS TO GO TO COURT AND HAVE A
          TRIAL IN FRONT OF A JUDGE OR A JURY, instead electing that all claims
          and disputes shall be resolved by arbitration under this Arbitration
          Agreement. In the event any litigation should arise between you and
        ...
        <p>
          <strong> (I). Confidentiality.</strong> All aspects of the arbitration
        ...
        <p>
          <strong> (M). Emergency Equitable Relief.</strong> Notwithstanding the
        ...
        <p>
          ...
          of the courts located within Harris County, Texas, for such purpose.{" "}
        </p>
        <p>
        ...
        <p>
          <strong> (14.2). Disclosures. </strong> The company is located at the
          address in Section 12.10. If you are a California resident, you may
        ...
        <p>
          ...
          that such communications would satisfy if it were to be in a hardcopy
          writing. The foregoing does not affect your non-waivable rights.{" "}
        </p>
        <p>
          <strong> (14.4). Entire Terms.</strong> These Terms constitute the
          entire agreement between you and us regarding the use of the Site. Our
          ...
          extent permitted by law. These Terms, and your rights and obligations
          ...
          freely assign these Terms. The terms and conditions set forth in these
          Terms shall be binding upon assignees.{" "}
        </p>
        <p>
          <strong> (14.5). Governing Law.</strong> The use of Company’s website
          and platform, your rights and obligations, and all actions
        ...
        <p>
          <strong> (14.6). Severability.</strong> If any part or parts of these
          Terms are found under the law to be invalid or unenforceable by a
        ...
        <p>
          <strong> (14.7). Trademark Information.</strong> All trademarks, logos
          and service marks (“Marks”) displayed on the Site are our property or
